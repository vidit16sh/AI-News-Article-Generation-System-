...
const SOURCES = [
    ...
    "https://news.google.com/rss/search?q=site:decrypt.co+when:1d&hl=en-US&gl=US&ceid=US:en",
    ...
    // --- TIER 2: ALLOWED DIRECT FEEDS ---
    // These specific sites usually allow bots, so direct RSS is fine.
